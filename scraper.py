...
class CovidUpdateGetter:
	...
	def get_value_from_html(self):
		...
		total_cases_div = self.soup.find_all('div',class_='maincounter-number')
	...
	def main(self):
		...
		self.print_values_and_exit(self.total,self.death,self.recovered,self.lasthours)



if __name__ == "__main__":
  worldmeter = CovidUpdateGetter('https://www.worldometers.info/coronavirus/country/nepal')
  worldmeter.main()
